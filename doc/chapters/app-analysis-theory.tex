...
Nor did the inversion buy anything there. With no correction at all, both mains were already time-coherent to within \SI{0.2}{\milli\second} in every octave from \SIrange{125}{4000}{\hertz}, the arrival time of each band's envelope measured against the direct sound at every seat. Linear phase moved none of those bands by more than \SI{0.1}{\milli\second}. The only band that moved is \SI{63}{\hertz}, where the magnitude correction does the work, since flattening a minimum-phase roll-off flattens its phase with it: \SI{4.4}{\milli\second} late uncorrected, \SI{1.7}{\milli\second} in minimum phase, \SI{1.4}{\milli\second} in linear phase.
...
\toprule
 & & \multicolumn{5}{c}{pre-echo, last \SI{3}{\milli\second} (dB)} & summation \\
\cmidrule(lr){3-7}
 & design & \SI{250}{\hertz} & \SI{500}{\hertz} & \SI{1}{\kilo\hertz} & \SI{2}{\kilo\hertz} & \SI{4}{\kilo\hertz} & (dB) \\
\midrule
left main  & minimum phase         & $-51$ & $-46$ & $-40$ & $-43$ & $-53$ & $-0.81$ \\
           & linear, not limited   & $-36$ & $-28$ & $-36$ & $-40$ & $-39$ & $-0.52$ \\
           & linear, limited       & $-46$ & $-46$ & $-40$ & $-43$ & $-53$ & $-0.52$ \\
\midrule
right main & minimum phase         & $-45$ & $-48$ & $-40$ & $-43$ & $-52$ & $-0.76$ \\
           & linear, not limited   & $-28$ & $-29$ & $-33$ & $-42$ & $-40$ & $-0.60$ \\
           & linear, limited       & $-40$ & $-48$ & $-40$ & $-43$ & $-52$ & $-0.60$ \\
\bottomrule
\end{tabular}
\caption{What limiting the phase does, on a ten-position campaign crossed at
\SI{70}{\hertz}. Energy arriving in the \SI{3}{\milli\second} before the
direct sound, per octave, relative to that octave's energy after it, through
causal band filters so the analysis cannot move anything earlier; mean over the
positions. Summation efficiency through the crossover as in the paper,
unchanged by the limit to \SI{0.01}{\dB}, in-sample and leave-one-out alike.
The rows come from the dry captures convolved with each design. For the filter
that was actually exported unlimited, they agree with the measured full-system
run to \SIrange{1}{2}{\dB} above \SI{250}{\hertz}, and that run in turn agrees
with a recording of ticks played through the system.}
...
\paragraph{What it leaves.} Below $2f_x$ the linear-phase filter still puts energy ahead of the direct sound, \SIrange{-12}{-20}{\dB} in the \SIrange{63}{125}{\hertz} octaves within \SI{30}{\milli\second}. That is the alignment itself: without $A$ the \SI{63}{\hertz} octave sits at minimum-phase level, and no choice of main delay removes it. It buys \SIrange{0.2}{0.3}{\dB} of summation at the delay that campaign used. Above all, it keeps the summation within \SI{0.6}{\dB} of its best for any main delay from \SIrange{20}{34}{\milli\second}, a range over which minimum phase falls as low as \SI{-7}{\dB}. Whether that low-frequency pre-echo is audible is a listening question. \SI{30}{\milli\second} is less than two periods at \SI{63}{\hertz}.
